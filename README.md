...
- the pressure sensor alias: `o2smpb-02e` to `o2smpb_02e_zest_sensor_p_t_rh_X`
- the temperature sensor alias: `ams621x` to `ams621x_zest_sensor_p_t_rh_X`
- the humidity sensor alias: `htu21d` to `htu21d_zest_sensor_p_t_rh_X`
- the 1-wire sensor alias: `w1` to `1w_X`
...
- Update your device tree by adding the `ZEST_SENSOR_P_T_RH_ALT(port, 1w)` macro to the `app.overlay` file, with:
